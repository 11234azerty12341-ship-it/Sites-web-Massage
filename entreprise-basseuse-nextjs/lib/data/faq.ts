...
export const faqData: FAQItem[] = [
  {
    id: 1,
    question: 'Comment se déroule une séance de massage ?',
    answer: 'La séance commence par un échange pour comprendre vos besoins. Ensuite, vous vous installez confortablement et le massage débute dans une ambiance apaisante.',
  },
  {
    id: 2,
